...
#include "util.hpp"
    ...
    #undef IGNORE // Because Windows.h likes to believe the global namespace is its own property.
#endif            // _WIN32
    ...
    namespace test {
        ...
        class test_function {
          ...
          public:
            ...
            [[nodiscard]] const std::string &failure_message() const noexcept { return m_failure_message; }
        };
