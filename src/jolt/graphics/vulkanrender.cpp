...
namespace jolt {
    namespace graphics {
        void VulkanRenderTarget::select_depth_stencil_image_format() {
        ...
        void VulkanRenderTarget::initialize_depth_stencil_buffer() {
            console.debug("Initializing depth/stencil buffer");

            VkResult result;
            VulkanWindow const &window = *m_renderer.get_window();
            ...
            result =
              vkCreateImage(m_renderer.get_device(), &cinfo, get_vulkan_allocator(), &m_ds_image);
        ...
        void VulkanRenderTarget::initialize_render_pass() {
        ...
        void VulkanRenderTarget::initialize_framebuffer(view_array const &views) {
