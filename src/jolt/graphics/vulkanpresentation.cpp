...
namespace jolt {
    namespace graphics {
        void VulkanPresentationTarget::initialize() {
        ...
        void VulkanPresentationTarget::shutdown() {
        ...
        void VulkanPresentationTarget::acquire_next_image(
          VulkanSemaphore const *const semaphore, VulkanFence const *const fence) {
            VkResult result;
        ...
        void VulkanPresentationTarget::present_active_image(
          VulkanWaitSemaphoreActionSynchro const &synchro) {
