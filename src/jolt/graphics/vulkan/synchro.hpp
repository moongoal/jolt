#ifndef JLT_GRAPHICS_VULKAN_SYNCHRO_HPP
#define JLT_GRAPHICS_VULKAN_SYNCHRO_HPP
        ...
        namespace vulkan {
            ...
            class JLTAPI Fence {
              ...
              public:
                 ...
                 * @see reset().
                 */
                static void reset_multiple(Fence const *const fences, uint32_t const n);
            ...
            class JLTAPI Semaphore {
              ...
              public:
                 ...
                 * @param value The value used to initialize a timeline semaphore. Ignored
                 * otherwise.
                 */
                explicit Semaphore(
                  Renderer const &renderer,
                 ...
                 *
                 * @param timeout The amount of time (in nanoseconds) to wait for the semaphore
                 * before giving up. Set to 0 to poll and return immediately.
                 *
                 ...
                 * @param out_counters An output array of `n` elements that will be populated with
                 * the semaphore counters.
                 * @param timeout The amount of time (in nanoseconds) to wait for the semaphore
                 * before giving up. Set to 0 to poll and return immediately.
            ...
            struct WaitSemaphoreActionSynchro {
                ...
                VkPipelineStageFlags
                  wait_semaphores_stages[JLT_MAX_SEMAPHORES]; /*< A bitmask indicating where each
                                                                 `wait_semaphore` must be awaited
                                                                 at. */
            };
            ...
            struct SemaphoreActionSynchro :
              public WaitSemaphoreActionSynchro,
...
#endif /* JLT_GRAPHICS_VULKAN_SYNCHRO_HPP */
